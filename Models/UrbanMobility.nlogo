...
Modeling daily movements of individuals inside a city. The main interest is to look at shares between public transport, foot and car movements.

## HOW IT WORKS

Agents are individuals that have a given timetable for a day, and also particular origins and destination. According to that, they make decisions on which transport to use (TODO more details) and route themselves in the city network.
In the case of a travel by car, they are able to decide to change their route if the road is congested.

## HOW TO USE IT

Launch a simulation on a day to see the evolution of local flows, places of congestions at different times, etc.
A direct application is the comparison between two different public transportation networks in input, what corresponds to a proposal for a new infrastructure for example. One first motivation for building the model was to proceed to multi-criteria optimisation for such implantation.
...
https://github.com/CSSS2013UrbanMobility/UrbanMobility
@#$#@#$#@
default
true
0
